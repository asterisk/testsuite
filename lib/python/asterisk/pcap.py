...
class VOIPProxy(VOIPSniffer):
    ...
    This module will listen a UDP ports and forward packets to some
    destination based on provided rules. Received packets are
    interpreted as SIP, RTP, and RTCP packets, and passed off to observers.
